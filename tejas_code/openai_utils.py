...
cost_dict = {
    ...
    'gpt4.1': {'input': 2/1000000, 'output': 8/1000000},
}
...
class OpenAICaller:
    ...
    def __init__(self):
        ...
        self.VALID_CHATGPT_MODELS = ['chatgpt', 'chatgpt-16k', 'gpt4', 'gpt4o', 'gpt4.1']#, 'chatgpt-16k', 'gpt4-32k', 'gpt4-1106']
    ...
    def set_openai_keys(self, openai_config_file='/home/tejas/data/openai_config_glamor_feb2025.yaml'):
        '''
        Set API keys
        '''
